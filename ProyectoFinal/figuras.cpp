...
void CFiguras::prisma_pasto(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::suelo(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 12.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(12.0f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(12.0f, 12.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 12.0f); glVertex3fv(vertice[7]);
	glEnd();
}


void CFiguras::piso_interno(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prismaJ(float altura, float largo, float profundidad, GLuint text1, GLuint text2)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, text2);		  //glBindTexture(GL_TEXTURE_2D, texture[filter]);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
							//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
...
void CFiguras::poster(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
