...
void CFiguras::prisma_muro(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(2.5f, 2.5f); glVertex3fv(vertice[7]);
	glTexCoord2f(2.5f, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(2.5f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(2.5f, 2.5f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 2.5f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(2.5f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(2.5f, 2.5f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 2.5f); glVertex3fv(vertice[3]);
	glEnd();

	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 10.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(2.5f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(2.5f, 2.5f); glVertex3fv(vertice[6]);
